...
img = text2image(args.prompt, img_height = args.H, img_width = args.W, text_encoder = text_encoder, diffusion_model = diffusion_model, decoder = decoder, batch_size = 1, n_steps = args.steps, unconditional_guidance_scale = args.scale, temperature = 1)
